...
if(isset($_POST['rsubmit']))
{
  ...
  else
  {
      ...
      else
      {
        ...
        {
          $insertquery = "INSERT INTO registration_tb (`username`, `email`, `mobile`, `fpassword`, `cpassword`, `token`, `status`) VALUES('$username', '$email', '$mobile', '$pass', '$cpass','$token','Inactive') ";
  ...
  <div class="row mt-4 mb-4">
    <div class="col-md-6 offset-md-3">
      <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" class="shadow-lg p-4" method="POST">
        ...
        <button type="submit" name="rsubmit" class="btn btn-outline-dark mt-3 btn-block shadow-sm font-weight-bold">Sign Up</button>
        <div class="text-center mt-1">Already a mamber?<a href="Teacher/TeacherLogin.php">Login</a></div>
